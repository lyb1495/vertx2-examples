...
public class IntegratedChatWithLoginServerStarterVerticle extends Verticle {
	...
	public void start() {
		...
		container.deployVerticle("com.github.iyboklee.ch5.IntegratedSockJSEbbChatWithLoginServerVerticle");
		container.deployVerticle("com.github.iyboklee.ch5.IntegratedTCPChatWithLoginServerVerticle");
	}
