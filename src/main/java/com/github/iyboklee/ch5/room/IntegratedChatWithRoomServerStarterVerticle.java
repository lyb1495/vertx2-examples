...
public class IntegratedChatWithRoomServerStarterVerticle extends Verticle {
	...
	public void start() {
		...
		container.deployVerticle("com.github.iyboklee.ch5.room.IntegratedSockJSEbbChatWithRoomServerVerticle");
		container.deployVerticle("com.github.iyboklee.ch5.room.IntegratedTCPChatWithRoomServerVerticle");
	}
