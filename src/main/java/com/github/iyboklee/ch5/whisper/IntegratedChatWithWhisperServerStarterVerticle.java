...
public class IntegratedChatWithWhisperServerStarterVerticle extends Verticle {
	...
	public void start() {
		...
		container.deployVerticle("com.github.iyboklee.ch5.whisper.IntegratedSockJSEbbChatWithWhisperServerVerticle");
		container.deployVerticle("com.github.iyboklee.ch5.whisper.IntegratedTCPChatWithWhisperServerVerticle");
	}
